...
Area 1                   Area 0 (MPLS Core)                      Area 2
------       ------------------------------------------          ------

              R3 (1.1.1.3) ---7.1.1.4/30--- R4 (1.1.1.4)
             /                               \
R1 -8.1.1.0/30- R2 (1.1.1.2)                9.1.1.0/30 --- R6 (1.1.1.6)
             \                               /
              R5 (1.1.1.5) ---7.1.1.8/30---/

  R2-R3: 7.1.1.0/30   R2-R5: 7.1.1.12/30   R3-R4: 7.1.1.4/30
